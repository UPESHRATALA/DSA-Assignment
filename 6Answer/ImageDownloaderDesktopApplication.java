...
public class ImageDownloaderDesktopApplication {
    ...
    public ImageDownloaderDesktopApplication() {
        ...
        executor = Executors.newFixedThreadPool(2); // Initialize the ExecutorService with a fixed thread pool size
    }
    ...
    private void initialize() {
        ...
        JLabel[] urlLabels = new JLabel[3]; // Array of JLabels for URL labels
        urlFields = new JTextField[3]; // Array of JTextFields for URL input
        progressBars = new JProgressBar[3]; // Array of JProgressBars for progress indication
